...
系统将复杂的数据输入一个独家算法，输出 **0 (不建议买)** 到 **100 (值得买入)** 的评分。

| 分数区间 | 定义 | 天气 | 投资策略 |
| :--- | :--- | :--- | :--- |
| **80 - 100** | **值得买入** | ☀️ 烈日 | 债券便宜，当前是较好的买点，可以大胆建仓。 |
| **60 - 80** | **可以买入** | 🌤️ 晴朗 | 估值合理偏低，适合定投或分批建仓。 |
| **40 - 60** | **持有观望** | ☁️ 多云 | 估值中性，已持仓可继续持有，新资金暂缓。 |
| **20 - 40** | **暂缓买入** | 🌧️ 小雨 | 估值偏贵，建议等待更好的入场时机。 |
| **0 - 20** | **不建议买** | ⛈️ 暴雨 | 估值过高，风险大于收益，建议回避。 |
...
*   **MA60 (60日均线)**:
    ...
    *   *判定*:
        ...
        *   **Yield > MA60**: 利率在均线上方运行，债券相对便宜 → 可能是买点。
    *   *注意*: 趋势仅作参考，核心看估值分位。

### 4. 动量与情绪 (Tactical) - 权重 15%
*   **MACD (异同移动平均线)**:
    *   *作用*: 判断趋势的强弱和转折。
...
### 5. 宏观对冲 (Macro Hedge) - 权重 10%
*   **ERP (股权风险溢价 / 股债利差)**:
    *   *公式*: `(1 / 沪深300市盈率) - 10年国债收益率`
    *   *逻辑*: 资金永远流向性价比高的地方。
    *   *警报*: 当 **ERP > 5.5%** 时，说明股票比债券便宜太多了。主力资金可能会**卖出债券，去买股票**。这对债市是巨大的抽血风险（即使债券本身看起来不贵）。

### 6. 中美利差变化 (CN-US Spread Trend) - 辅助因子
*   **中美利差**:
    *   *公式*: `中国10年期国债收益率 - 美国10年期国债收益率`
    *   *核心逻辑*: **看变化趋势，不看绝对值**
    *   *为什么？*: 过去2年利差一直倒挂（负值），但债券走了大牛市。关键是利差在"变好"还是"变差"。
    *   *判定*（60日变化）:
        *   **利差收窄 > +0.3%**: 美联储降息或中国加息 → 降息空间变大 → 利好债市 (+8分)
        *   **利差走阔 < -0.3%**: 美联储加息或中国降息 → 降息空间变小 → 利空债市 (-8分)
        *   **利差平稳**: 变化在 ±0.3% 之间，不影响评分
    *   *示例*: 利差从 -2.5% 变成 -2.0%，虽然还是负的，但收窄了 0.5%，说明压力在减轻，利好债市。

### 7. 流动性变化 (Liquidity Trend) - 辅助因子
*   **Shibor (银行间拆借利率)**:
    *   *定义*: 银行之间互相借钱的成本。它是债市的"水源"。
    *   *核心逻辑*: **看变化趋势，不看绝对值**
    *   *为什么？*: 过去几年利率中枢持续下移，用固定阈值会失效。关键是资金面在"变松"还是"变紧"。
    *   *判定*（20日变化）:
        *   **Shibor下降 > 30bp**: 资金宽松 → 利好债市 (+8分)
        *   **Shibor上升 > 30bp**: 资金收紧 → 利空债市 (-8分)
        *   **变化在 ±30bp 之间**: 资金平稳，不影响评分
...
### 🐢 稳健型 (Conservative)
*   **适合人群**: 追求稳健收益，厌恶回撤，理财替代。
*   **策略**: 评分 ≥60 分时可以买入，40-60 分持有观望，<40 分暂缓买入。

### 🐇 激进型 (Aggressive)
*   **适合人群**: 交易型选手，能承受波动。
*   **策略**: 高分时可加大仓位，低分时减仓或等待，结合 ERP 进行股债轮动。
